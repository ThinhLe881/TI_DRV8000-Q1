...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_EC_HEAT_ITRIP_STAT_R_05h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_SPARE_STAT1_R_07h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_SPARE_STAT2_R_08h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_IDRV_CNFG_RW_0Ch_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_VGS_CNFG_RW_0Dh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_VDS_CNFG_RW_0Eh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_CSA_CNFG_RW_0Fh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_AGD_CNFG_RW_10h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_PDR_CNFG_RW_11h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_STC_CNFG_RW_12h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_SPARE_CNFG1_RW_13h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_ITRIP_DG_RW_14h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_OUT_CNFG1_RW_15h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_OUT_CNFG2_RW_16h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_OCP_CNFG_RW_17h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_OL_CNFG1_RW_18h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_OL_CNFG2_RW_19h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_SR_CNFG_RW_1Ah_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_ITRIP_CNFG_RW_1Bh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HB_ITRIP_FREQ_RW_1Ch_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_HEAT_OUT_CNFG_RW_1Dh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_OC_CNFG_RW_1Eh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_OL_CNFG_RW_1Fh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_REG_CNFG1_RW_20h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_REG_CNFG2_RW_21h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_PWM_FREQ_CNFG_RW_22h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_SPARE_CNFG2_RW_26h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_SPARE_CNFG3_RW_27h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_SPARE_CNFG4_RW_28h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_GD_HB_CTRL_RW_2Ah_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_HS_EC_HEAT_CTRL_RW_2Bh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT7_PWM_DC_RW_2Ch_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT8_PWM_DC_RW_2Dh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT9_PWM_DC_RW_2Eh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT10_PWM_DC_RW_2Fh_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT11_PWM_DC_RW_30h_t;
...
typedef volatile union
{
    ...
    uint16_t w_Reg;
} un_DRV8000_OUT12_PWM_DC_RW_31h_t;
...
typedef struct
{
    ...
    /* ************* STATUS REGISTERS ********************************* */
    /* **************************************************************** */
    un_DRV8000_IC_STAT1_R_00h_t un_Reg_IC_STAT1;
    un_DRV8000_IC_STAT2_R_01h_t un_Reg_IC_STAT2;
    un_DRV8000_GD_STAT_R_02h_t un_Reg_GD_STAT;
    un_DRV8000_HB_STAT1_R_03h_t un_Reg_HB_STAT1;
    un_DRV8000_HB_STAT2_R_04h_t un_Reg_HB_STAT2;
    un_DRV8000_EC_HEAT_ITRIP_STAT_R_05h_t un_Reg_EC_HEAT_ITRIP_STAT;
    un_DRV8000_HS_STAT_R_06h_t un_Reg_HS_STAT;
    // un_DRV8000_SPARE_STAT1_R_07h_t                  un_Reg_SPARE_STAT1; // spare reg
    un_DRV8000_SPARE_STAT2_R_08h_t un_Reg_SPARE_STAT2; // Device ID reg

    /* **************************************************************** */
    /* ************* CONFIG REGISTERS ********************************* */
    /* **************************************************************** */
    un_DRV8000_IC_CNFG1_RW_09h_t un_Reg_IC_CNFG1;
    un_DRV8000_IC_CNFG2_RW_0Ah_t un_Reg_IC_CNFG2;
    un_DRV8000_GD_CNFG_RW_0Bh_t un_Reg_GD_CNFG;
    un_DRV8000_GD_IDRV_CNFG_RW_0Ch_t un_Reg_GD_IDRV_CNFG;
    un_DRV8000_GD_VGS_CNFG_RW_0Dh_t un_Reg_GD_VGS_CNFG;
    un_DRV8000_GD_VDS_CNFG_RW_0Eh_t un_Reg_GD_VDS_CNFG;
    un_DRV8000_GD_CSA_CNFG_RW_0Fh_t un_Reg_GD_CSA_CNFG;
    un_DRV8000_GD_AGD_CNFG_RW_10h_t un_Reg_GD_AGD_CNFG;
    un_DRV8000_GD_PDR_CNFG_RW_11h_t un_Reg_GD_PDR_CNFG;
    un_DRV8000_GD_STC_CNFG_RW_12h_t un_Reg_GD_STC_CNFG;
    // un_DRV8000_GD_SPARE_CNFG1_RW_13h_t              un_Reg_GD_SPARE_CNFG1; // spare reg
    un_DRV8000_HB_ITRIP_DG_RW_14h_t un_Reg_HB_ITRIP_DG;
    un_DRV8000_HB_OUT_CNFG1_RW_15h_t un_Reg_HB_OUT_CNFG1;
    un_DRV8000_HB_OUT_CNFG2_RW_16h_t un_Reg_HB_OUT_CNFG2;
    un_DRV8000_HB_OCP_CNFG_RW_17h_t un_Reg_HB_OCP_CNFG;
    un_DRV8000_HB_OL_CNFG1_RW_18h_t un_Reg_HB_OL_CNFG1;
    un_DRV8000_HB_OL_CNFG2_RW_19h_t un_Reg_HB_OL_CNFG2;
    un_DRV8000_HB_SR_CNFG_RW_1Ah_t un_Reg_HB_SR_CNFG;
    un_DRV8000_HB_ITRIP_CNFG_RW_1Bh_t un_Reg_HB_ITRIP_CNFG;
    un_DRV8000_HB_ITRIP_FREQ_RW_1Ch_t un_Reg_HB_ITRIP_FREQ;
    un_DRV8000_HS_HEAT_OUT_CNFG_RW_1Dh_t un_Reg_HS_HEAT_OUT_CNFG;
    un_DRV8000_HS_OC_CNFG_RW_1Eh_t un_Reg_HS_OC_CNFG;
    un_DRV8000_HS_OL_CNFG_RW_1Fh_t un_Reg_HS_OL_CNFG;
    un_DRV8000_HS_REG_CNFG1_RW_20h_t un_Reg_HS_REG_CNFG1;
    un_DRV8000_HS_REG_CNFG2_RW_21h_t un_Reg_HS_REG_CNFG2;
    un_DRV8000_HS_PWM_FREQ_CNFG_RW_22h_t un_Reg_HS_PWM_FREQ;
    un_DRV8000_HEAT_CNFG_RW_23h_t un_Reg_HEAT_CNFG;
    un_DRV8000_EC_CNFG_RW_24h_t un_Reg_EC_CNFG;
    un_DRV8000_HS_OCP_DG_RW_25h_t un_Reg_HS_OCP_DG;
    // un_DRV8000_SPARE_CNFG2_RW_26h_t                 un_Reg_SPARE_CNFG2; // spare reg
    // un_DRV8000_SPARE_CNFG3_RW_27h_t                 un_Reg_SPARE_CNFG3; // spare reg
    // un_DRV8000_SPARE_CNFG4_RW_28h_t                 un_Reg_SPARE_CNFG4; // spare reg

    /* **************************************************************** */
    /* ************* CONTROL REGISTERS ******************************** */
    /* **************************************************************** */
    un_DRV8000_IC_CTRL_RW_29h_t un_Reg_IC_CTRL;
    un_DRV8000_GD_HB_CTRL_RW_2Ah_t un_Reg_GD_HB_CTRL;
    un_DRV8000_HS_EC_HEAT_CTRL_RW_2Bh_t un_Reg_HS_EC_HEAT_CTRL;
    un_DRV8000_OUT7_PWM_DC_RW_2Ch_t un_Reg_OUT7_PWM_DC;
    un_DRV8000_OUT8_PWM_DC_RW_2Dh_t un_Reg_OUT8_PWM_DC;
    un_DRV8000_OUT9_PWM_DC_RW_2Eh_t un_Reg_OUT9_PWM_DC;
    un_DRV8000_OUT10_PWM_DC_RW_2Fh_t un_Reg_OUT10_PWM_DC;
    un_DRV8000_OUT11_PWM_DC_RW_30h_t un_Reg_OUT11_PWM_DC;
    un_DRV8000_OUT12_PWM_DC_RW_31h_t un_Reg_OUT12_PWM_DC;
} st_DRV8000_REGS_t;
